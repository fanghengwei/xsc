...
class Foreignteachers extends Model
{
    ...
    public function getList($input) {
        ...
        foreach ($list as &$val) {
            $city1 = Db::table(config('alias.areas'))->field('province,city')->where('code',$val['expected_city_2'])->select();
            if($city1){
