            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'passport',operate:false, title: __('Passport No.')},
                        ...
                        { field: 'certificate',operate:false, title: __('Certificate'), searchList: {"TEFL":__('Tefl'),"Teacher certificate":__('Teacher certificate'),"Others":__('Others'),"None":__('None')}, formatter: Table.api.formatter.label},
                        ...
                        {field: 'visa_status',operate:false, title: __('Visa_status'), searchList: {"Work Visa":__('Work visa'),"Tourist Visa":__('Tourist visa'),"Family Visa":__('Family visa'),"Student Visa":__('Student visa'),"Business Visa":__('Business visa'),"Permenant Visa":__('Permenant visa'),"Other visa":__('Other visa')}, formatter: Table.api.formatter.status},
                        ...
                        { field: 'recorder', title: __('Recorder'),searchList:Config.admin_list},
